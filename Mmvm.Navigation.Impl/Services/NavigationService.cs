...
namespace Israiloff.Mmvm.Net.Navigation.Impl.Services
{
    ...
    public class NavigationService : INavigationService
    {
        ...
        public NavigationService(ILogger logger, INavigationUtilityService utilityService)
        {
            Logger = logger;
        ...
        private INavigationUtilityService UtilityService { get; }
        ...
        public void NavigateBack(BranchInfo branchInfo)
        {
        ...
        public void NavigateBack(BranchInfo branchInfo, uint backStepCount)
        {
        ...
        public void NavigateBack(BranchInfo branchInfo, string nodeName)
        {
        ...
        public INavigationNode CreateTree(string nodeName)
        {
            ...
            if (!UtilityService.TryGetPageObject(nodeName, out var navigatingPageVm))
            {
        ...
        public void NavigateTo(NavigateArgs navigateArgs)
        {
            ...
            if (!UtilityService.TryGetPageObject(navigateArgs.NodeName, out var navigatingPageVm))
            {
